...
### 任务 5：历史日 K、按需分钟 K 与 Parquet 归档
...
### 任务 10：固定数据端到端测试、运行脚本、在线烟雾测试与文档
